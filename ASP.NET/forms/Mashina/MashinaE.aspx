...
<div class="clearfix">
  <asp:Label CssClass="descLbl" ID="ctrlВладелецМашины_ФИОLabel" runat="server" Text="ФИО" EnableViewState="False">
</asp:Label>
<asp:TextBox CssClass="descTxt" ID="ctrlВладелецМашины_ФИО" runat="server" ReadOnly="true">
</asp:TextBox>
