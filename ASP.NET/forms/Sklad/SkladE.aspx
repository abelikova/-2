...
<div class="clearfix">
  <asp:Label CssClass="descLbl" ID="ctrlВладелецСклада_ФИОLabel" runat="server" Text="ФИО" EnableViewState="False">
</asp:Label>
<asp:TextBox CssClass="descTxt" ID="ctrlВладелецСклада_ФИО" runat="server" ReadOnly="true">
</asp:TextBox>
